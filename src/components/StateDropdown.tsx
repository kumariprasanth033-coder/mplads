  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          role="listbox"
          className="fixed sm:absolute z-50 left-4 right-4 sm:left-0 sm:right-auto sm:w-80 mt-1 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden text-xs flex flex-col animate-in fade-in zoom-in-95 duration-150 max-h-[380px]"
          style={{
